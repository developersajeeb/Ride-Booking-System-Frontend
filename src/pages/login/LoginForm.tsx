...
export function LoginForm({
    ...
    return (
        <div className={cn("flex flex-col gap-6 w-full max-w-[380px] border border-gray-200 rounded-lg bg-gray-50 dark:border-gray-800 dark:bg-[#18181B]", className)} {...props}>
            <Form {...form}>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-1">
                                    <Label className="font-semibold text-gray-600 dark:text-gray-400 text-sm" htmlFor="email">Email</Label>
                                    <FormControl>
                                        <Input
                            ...
                            render={({ field }) => (
                                <FormItem className="space-y-1">
                                    <div className="flex items-center gap-1">
                                        <Label className="font-semibold text-gray-600 dark:text-gray-400 text-sm" htmlFor="password">Password</Label>
                                        <Link
                                            to="/forgot-password"
